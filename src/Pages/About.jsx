...
import profilePhoto from "../assets/66.png"
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Saya adalah mahasiswa Teknik Informatika yang berfokus pada pengembangan Back-End. Saya berfokus pada perancangan sistem, API, dan pengelolaan basis data yang efisien, serta selalu berupaya memberikan solusi yang aman dan andal dalam setiap proyek yang saya kerjakan.
            </p>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1j3z_HZ3l9BbThpySqnCNsYIC6zV508Hg/view?usp=sharing" className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
