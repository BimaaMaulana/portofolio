...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/bima-maulana-id/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Bima Maulana_",
    icon: Instagram,
    url: "https://www.instagram.com/bimaaamaulana_/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@Bima Maulana",
    icon: Youtube,
    url: "https://www.youtube.com/@bimaaamaulana",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@Bima Maulana",
    icon: Github,
    url: "https://github.com/BimaaMaulana",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@yagami.warkop",
    color: "black",
