...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/Bima Maulana",
      };
  ...
  const projectUrl = `https://Bima Maulana.com/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Bima Maulana </title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Bima Maulana  — Backend Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Bima Maulana `}
        />
        <meta
